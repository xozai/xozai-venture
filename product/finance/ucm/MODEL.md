...
(engine #16, assumptions #14) on 2026-08-30. Workbook: `output/model.xlsx` (formula-driven; Checks tab all TRUE).
...
of efficiency. Section B of the GTM cost model (events/booths) is a Scribe straw man awaiting HermesX
sign-off (HermesX is currently out of credits). Gross margin of 93–94% reflects only LLM/hosting COGS; support
...
| Additional capital need | $382,826 | $280,023 | $740,217 |
| Ending cash (m36) | −$250,147 | $598,083 | −$740,217 |
...
`research/FINANCIAL_BENCHMARKS.md` (#11, #13); GTM: `marketing/GTM_COST_MODEL.md` (#12, #15); build:
